...
(function (global, factory) {
            ...
            (function (j) {
                ...
                var a = "classList",
                    ...
                    c = Array[f].indexOf || function (q) {
                        var p = 0,
                            o = this.length;
                        for (; p < o; p++) { if (p in this && this[p] === q) { return p } }
                        return -1
                    },
                    n = function (o, p) {
                        this.name = o;
                    ...
                    d = function (s) {
                        var r = k.call(s.getAttribute("class") || ""),
                            ...
                            p = 0,
                            o = q.length;
                        for (; p < o; p++) { this.push(q[p]) } this._updateClassName = function () { s.setAttribute("class", this.toString()) }
                    },
                    e = d[f] = [],
    ...
    */
    ...
    /* 2020-05-17 注意根目录的绝对路径为 rtmpvideo */
    var jqueryJS = './ezuikit/js/jquery.min.js';
    var ckplayerJS = './ezuikit/js/ckplayer/ckplayer.js';
    var ckplayerSWF = './ezuikit/js/ckplayer/ckplayer.swf';
    var m3u8SWF = './ezuikit/js/ckplayer/m3u8.swf';
    var flv_js = './ezuikit/js/sdk/js/flv.min.js';
    var hlsJS = './ezuikit/js/hls.min.js';
    var mpegJS = './ezuikit/js/jsmpeg.min.js';
    var wav = './ezuikit/js/wav-audio-encoder.js';
